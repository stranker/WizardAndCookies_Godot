...
func _init_wizards_data():
	var initial_wizards_data = GameManager.wizards_initial_data
	for wizard_data in initial_wizards_data:
		var new_wiz_data = wizard_data.duplicate()
		wizards_data.append(new_wiz_data)
